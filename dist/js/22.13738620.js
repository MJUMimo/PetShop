 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ae{constructor(t,e,s,n){this.url=t,this.method=e,this.handler=s,this.timeout=n,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ee(t){if(!t)throw mt()}function Ie(t,e){function s(s,n){const r=Ce(t,n,e);return Ee(null!==r),r}return s}function De(t,e){function s(s,n){const r=Ce(t,n,e);return Ee(null!==r),Se(r,n,t.host,t._protocol)}return s}function qe(t){function e(e,s){let n;return n=401===e.getStatus()?e.getErrorText().includes("Firebase App Check token is invalid")?vt():wt():402===e.getStatus()?gt(t.bucket):403===e.getStatus()?yt(t.path):s,n.serverResponse=s.serverResponse,n}return e}function Be(t){const e=qe(t);function s(s,n){let r=e(s,n);return 404===s.getStatus()&&(r=bt(t.path)),r.serverResponse=n.serverResponse,r}return s}function ze(t,e,s){const n=e.fullServerUrl(),r=Xt(n,t.host,t._protocol),o="GET",a=t.maxOperationRetryTime,i=new Ae(r,o,Ie(t,s),a);return i.errorHandler=Be(e),i}function Ne(t,e,s){const n=e.fullServerUrl(),r=Xt(n,t.host,t._protocol),o="GET",a=t.maxOperationRetryTime,i=new Ae(r,o,De(t,s),a);return i.errorHandler=Be(e),i}function Le(t,e){return t&&t["contentType"]||e&&e.type()||"application/octet-stream"}function Me(t,e,s){const n=Object.assign({},s);return n["fullPath"]=t.path,n["size"]=e.size(),n["contentType"]||(n["contentType"]=Le(null,e)),n}function Fe(t,e,s,n,r){const o=e.bucketOnlyServerUrl(),a={"X-Goog-Upload-Protocol":"multipart"};function i(){let t="";for(let e=0;e<2;e++)t+=Math.random().toString().slice(2);return t}const c=i();a["Content-Type"]="multipart/related; boundary="+c;const l=Me(e,n,r),u=Oe(l,s),d="--"+c+"\r\nContent-Type: application/json; charset=utf-8\r\n\r\n"+u+"\r\n--"+c+"\r\nContent-Type: "+l["contentType"]+"\r\n\r\n",h="\r\n--"+c+"--",p=me.getBlob(d,n,h);if(null===p)throw Ut();const _={name:l["fullPath"]},f=Xt(o,t.host,t._protocol),m="POST",b=t.maxUploadRetryTime,g=new Ae(f,m,Ie(t,s),b);return g.urlParams=_,g.headers=a,g.body=p.uploadData(),g.errorHandler=qe(e),g}class He{constructor(t,e,s,n){this.current=t,this.total=e,this.finalized=!!s,this.metadata=n||null}}function je(t,e){let s=null;try{s=t.getResponseHeader("X-Goog-Upload-Status")}catch(r){Ee(!1)}const n=e||["active"];return Ee(!!s&&-1!==n.indexOf(s)),s}function $e(t,e,s,n,r){const o=e.bucketOnlyServerUrl(),a=Me(e,n,r),i={name:a["fullPath"]},c=Xt(o,t.host,t._protocol),l="POST",u={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${n.size()}`,"X-Goog-Upload-Header-Content-Type":a["contentType"],"Content-Type":"application/json; charset=utf-8"},d=Oe(a,s),h=t.maxUploadRetryTime;function p(t){let e;je(t);try{e=t.getResponseHeader("X-Goog-Upload-URL")}catch(s){Ee(!1)}return Ee(Ht(e)),e}const _=new Ae(c,l,p,h);return _.urlParams=i,_.headers=u,_.body=d,_.errorHandler=qe(e),_}function Ve(t,e,s,n){const r={"X-Goog-Upload-Command":"query"};function o(t){const e=je(t,["active","final"]);let s=null;try{s=t.getResponseHeader("X-Goog-Upload-Size-Received")}catch(o){Ee(!1)}s||Ee(!1);const r=Number(s);return Ee(!isNaN(r)),new He(r,n.size(),"final"===e)}const a="POST",i=t.maxUploadRetryTime,c=new Ae(s,a,o,i);return c.headers=r,c.errorHandler=qe(e),c}const Xe=262144;function Ge(t,e,s,n,r,o,a,i){const c=new He(0,0);if(a?(c.current=a.current,c.total=a.total):(c.current=0,c.total=n.size()),n.size()!==c.total)throw Ct();const l=c.total-c.current;let u=l;r>0&&(u=Math.min(u,r));const d=c.current,h=d+u,p=u===l?"upload, finalize":"upload",_={"X-Goog-Upload-Command":p,"X-Goog-Upload-Offset":`${c.current}`},f=n.slice(d,h);if(null===f)throw Ut();function m(t,s){const r=je(t,["active","final"]),a=c.current+u,i=n.size();let l;return l="final"===r?Ie(e,o)(t,s):null,new He(a,i,"final"===r,l)}const b="POST",g=e.maxUploadRetryTime,w=new Ae(s,b,m,g);return w.headers=_,w.body=f.uploadData(),w.progressCallback=i||null,w.errorHandler=qe(t),w}
/**
 * @license
 * Copyright 2017 Google LLC
 *
